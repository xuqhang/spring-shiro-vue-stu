...
CREATE TABLE `question_choic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='选择题库，question_type2单选，3多选';
...
CREATE TABLE `question_exam` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='考试安排';
...
CREATE TABLE `question_exam_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='考试记录表';
...
CREATE TABLE `question_fill_judge` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='填空题和判断题库，question_type，0填空1判断';
...
CREATE TABLE `question_paper` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='试卷';
...
CREATE TABLE `t_teacher` (
  ...
  `sex` int(11) NOT NULL COMMENT '性别',
  `age` int(11) NOT NULL COMMENT '年龄',
  `title` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '鑱岀О',
  `email` varchar(50) DEFAULT NULL COMMENT '邮箱',
  `photo_url` varchar(200) DEFAULT NULL COMMENT '头像地址',
